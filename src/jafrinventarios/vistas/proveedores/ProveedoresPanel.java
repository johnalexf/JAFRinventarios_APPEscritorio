...
public class ProveedoresPanel extends javax.swing.JPanel {
    ...
    private void initComponents() {
        ...
        lblTituloNombreComercial.setFont(new java.awt.Font("Arial", 1, 16)); // NOI18N
        lblTituloNombreComercial.setHorizontalAlignment(javax.swing.SwingConstants.CENTER);
        lblTituloNombreComercial.setText("Nombre Comercial");
        lblTituloNombreComercial.setMaximumSize(new java.awt.Dimension(0, 0));
        lblTituloNombreComercial.setMinimumSize(new java.awt.Dimension(0, 0));
        lblTituloNombreComercial.setPreferredSize(new java.awt.Dimension(0, 0));
        gridBagConstraints = new java.awt.GridBagConstraints();
        gridBagConstraints.fill = java.awt.GridBagConstraints.BOTH;
        gridBagConstraints.weightx = 3.0;
        gridBagConstraints.weighty = 1.0;
        contenedorTitulosTabla.add(lblTituloNombreComercial, gridBagConstraints);
        ...
        tituloSinDatos.setText("Aún no tienes proveedores registrados");
        ...
        labelDescripcionSinDatos.setText("Comienza a organizar tu inventario agregando tu primer proveedor ahora mismo.");
    ...
    */
    ...
    /*
    Metodo para poder agregar toda la lista de proveedores recibida, por medio de
    LinkedHashMap mantenemos el orden en el cual ha sido enviada.
    */
    public void inyectarFilas( LinkedHashMap<Integer, FilaTablaProveedores> filasTablaProveedores ){
        removerContenido();
        
        filasTablaProveedores.values().forEach(fila -> {
    ...
    un nuevo proveedor
    */
    public void inyectarNuevaFila( FilaTablaProveedores fila ){
        contenedorContenidoTabla.add(fila);
        redubijarPanel();
    }
    
    public void eliminarFila ( FilaTablaProveedores fila ){
    ...
    */
    ...
    // Metodo para optener cual es el frame padre de la vista JPanel modulo de proveedores
