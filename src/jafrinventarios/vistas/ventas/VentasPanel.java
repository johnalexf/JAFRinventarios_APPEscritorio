...
public class VentasPanel extends javax.swing.JPanel {
    ...
    private void initComponents() {
        ...
        gridBagConstraints.weighty = 1.0;
        contenedorTitulosTabla.add(lblTituloCliente, gridBagConstraints);
        ...
        tituloSinDatos.setText("Aún no tienes ventas registradas");
        ...
        labelDescripcionSinDatos.setText("Comienza a organizar tu inventario agregando tu primera venta ahora mismo.");
    ...
    ============================================================================
    */
    // Disponible para cuando se muestren las ventas a un usuario no administrador
    ...
    /*
    Metodo para poder agregar toda la lista de ventas recibida, por medio de
    LinkedHashMap mantenemos el orden en el cual ha sido enviada.
    */
    public void inyectarFilas( LinkedHashMap<Integer, FilaTablaVentas> filasTablaVentas ){
        removerContenido();
        
        filasTablaVentas.values().forEach(fila -> {
    ...
    una nueva venta
    */
    public void inyectarNuevaFila( FilaTablaVentas fila ){
        contenedorContenidoTabla.add(fila,0);
        redibujarPanel();
    }
    
    public void eliminarFila ( FilaTablaVentas fila ){
