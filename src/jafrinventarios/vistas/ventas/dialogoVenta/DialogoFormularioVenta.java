...
package jafrinventarios.vistas.ventas.dialogoVenta;
 ...
 * @author JOHN FORERO
 */
public class DialogoFormularioVenta extends DialogoBaseConSombra {
    ...
    */
    ...
    private GestorFormulario formularioDatosVenta;
    ...
    */
    public DialogoFormularioVenta( Window parent, TipoDialogo tipoDialogo) {
        super(parent);
        initComponents();
        this.formularioDatosVenta = new GestorFormulario();
    ...
    private void configuracionInicial(){
        ...
        formularioDatosVenta.agregarCampoFechaHora( inputFechaYHora, lblErrorInputFechaHora, true );
        
        if(tipoDialogo == TipoDialogo.CREAR_NUEVA_VENTA){
            tituloFormulario.setText("Crear Venta");
            btnEnviarFormulario.setText("Crear Venta");
            /*
            ...
            */
            contenedorDatosGenerales.remove(contenedorIDVentayUsuario);
    ...
    private void initComponents() {
        ...
        contenedorIDVentayUsuario = new javax.swing.JPanel();
        contenedorIDVenta = new javax.swing.JPanel();
        ...
        contenedorClienteYFecha = new javax.swing.JPanel();
        contenedorCliente = new javax.swing.JPanel();
        lblTituloCliente = new javax.swing.JLabel();
        contenedorInputYErrorClientes = new javax.swing.JPanel();
        comboBoxClientes = new javax.swing.JComboBox<>();
        lblErrorComboBoxClientes = new javax.swing.JLabel();
        ...
        tituloFormulario.setText("Editar Venta");
        ...
        contenedorIDVentayUsuario.setMinimumSize(new java.awt.Dimension(0, 0));
        contenedorIDVentayUsuario.setOpaque(false);
        contenedorIDVentayUsuario.setPreferredSize(new java.awt.Dimension(0, 0));
        contenedorIDVentayUsuario.setLayout(new java.awt.GridBagLayout());

        contenedorIDVenta.setOpaque(false);
        contenedorIDVenta.setLayout(new java.awt.GridBagLayout());
        ...
        contenedorIDVenta.add(lblTituloId, gridBagConstraints);
        ...
        gridBagConstraints.weighty = 1.0;
        contenedorIDVenta.add(lblDatoId, gridBagConstraints);
        ...
        gridBagConstraints.weightx = 1.0;
        gridBagConstraints.weighty = 1.0;
        contenedorIDVentayUsuario.add(contenedorIDVenta, gridBagConstraints);
        ...
        gridBagConstraints.weightx = 1.0;
        gridBagConstraints.weighty = 1.0;
        contenedorIDVentayUsuario.add(contenedorUsuario, gridBagConstraints);

        contenedorDatosGenerales.add(contenedorIDVentayUsuario);

        contenedorClienteYFecha.setOpaque(false);
        contenedorClienteYFecha.setPreferredSize(new java.awt.Dimension(0, 0));
        contenedorClienteYFecha.setLayout(new java.awt.GridBagLayout());

        contenedorCliente.setMinimumSize(new java.awt.Dimension(0, 0));
        contenedorCliente.setOpaque(false);
        contenedorCliente.setPreferredSize(new java.awt.Dimension(0, 34));
        contenedorCliente.setLayout(new java.awt.GridBagLayout());

        lblTituloCliente.setFont(new java.awt.Font("Arial", 1, 16)); // NOI18N
        lblTituloCliente.setHorizontalAlignment(javax.swing.SwingConstants.TRAILING);
        lblTituloCliente.setText("Cliente :");
        lblTituloCliente.setVerticalAlignment(javax.swing.SwingConstants.TOP);
        lblTituloCliente.setBorder(javax.swing.BorderFactory.createEmptyBorder(8, 0, 0, 0));
        lblTituloCliente.setMaximumSize(new java.awt.Dimension(0, 0));
        lblTituloCliente.setMinimumSize(new java.awt.Dimension(0, 0));
        lblTituloCliente.setPreferredSize(new java.awt.Dimension(0, 0));
        gridBagConstraints = new java.awt.GridBagConstraints();
        gridBagConstraints.gridx = 0;
        gridBagConstraints.gridy = 0;
        gridBagConstraints.gridwidth = java.awt.GridBagConstraints.RELATIVE;
        ...
        gridBagConstraints.weighty = 1.0;
        gridBagConstraints.insets = new java.awt.Insets(0, 0, 0, 10);
        contenedorCliente.add(lblTituloCliente, gridBagConstraints);

        contenedorInputYErrorClientes.setOpaque(false);
        contenedorInputYErrorClientes.setLayout(new java.awt.BorderLayout());

        comboBoxClientes.setFont(new java.awt.Font("Arial", 0, 16)); // NOI18N
        comboBoxClientes.setModel(new javax.swing.DefaultComboBoxModel<>(new String[] { "Seleccionar Cliente" }));
        comboBoxClientes.setCursor(new java.awt.Cursor(java.awt.Cursor.HAND_CURSOR));
        comboBoxClientes.setMinimumSize(new java.awt.Dimension(0, 0));
        comboBoxClientes.setName("cliente"); // NOI18N
        comboBoxClientes.setPreferredSize(new java.awt.Dimension(0, 34));
        contenedorInputYErrorClientes.add(comboBoxClientes, java.awt.BorderLayout.NORTH);

        lblErrorComboBoxClientes.setFont(new java.awt.Font("Arial", 1, 13)); // NOI18N
        lblErrorComboBoxClientes.setForeground(new java.awt.Color(179, 38, 30));
        lblErrorComboBoxClientes.setAlignmentX(0.5F);
        lblErrorComboBoxClientes.setBorder(javax.swing.BorderFactory.createEmptyBorder(2, 8, 0, 0));
        lblErrorComboBoxClientes.setHorizontalTextPosition(javax.swing.SwingConstants.CENTER);
        lblErrorComboBoxClientes.setPreferredSize(new java.awt.Dimension(0, 17));
        contenedorInputYErrorClientes.add(lblErrorComboBoxClientes, java.awt.BorderLayout.SOUTH);
        ...
        gridBagConstraints.weightx = 3.0;
        gridBagConstraints.weighty = 1.0;
        contenedorCliente.add(contenedorInputYErrorClientes, gridBagConstraints);
        ...
        gridBagConstraints.weightx = 1.0;
        gridBagConstraints.weighty = 1.0;
        contenedorClienteYFecha.add(contenedorCliente, gridBagConstraints);
        ...
        gridBagConstraints.weightx = 1.0;
        gridBagConstraints.weighty = 1.0;
        contenedorClienteYFecha.add(contenedorFecha, gridBagConstraints);

        contenedorDatosGenerales.add(contenedorClienteYFecha);
        ...
        btnLinkEliminarRegistro.setText("Eliminar Venta");
    ...
    */
    ...
    //Exponer inicializar el combo box esperando la lista de clientes a asignar
    public void inicializarComboBoxClientes ( LinkedHashMap<Integer, String> diccionarioClientes ) {
        
        formularioDatosVenta.agregarCampoComboBox(comboBoxClientes,
                                                "Cliente",
                                                diccionarioClientes, 
                                                lblErrorComboBoxClientes, 
                                                true);
    ...
    */
    ...
    public void inyectarFilasDetalles( ArrayList<FilaFormularioDetalleVenta> filasDetalles ){
    ...
    public void inyectarNuevaFilaDetalle( FilaFormularioDetalleVenta filaDetalle ){
    ...
    public void removerFilaDetalle( FilaFormularioDetalleVenta filaDetalle){
    ...
    */
    ...
    private javax.swing.JPanel contenedorClienteYFecha;
    ...
    private javax.swing.JPanel contenedorIDVenta;
    private javax.swing.JPanel contenedorIDVentayUsuario;
    private javax.swing.JPanel contenedorInputYErrorClientes;
    ...
    private javax.swing.JLabel lblErrorComboBoxClientes;
