...
public class ClientesPanel extends javax.swing.JPanel {
    ...
    private void initComponents() {
        ...
        lblTituloNombreNegocio = new javax.swing.JLabel();
        lblTituloNombreContacto = new javax.swing.JLabel();
        ...
        lblTituloNombreNegocio.setFont(new java.awt.Font("Arial", 1, 16)); // NOI18N
        lblTituloNombreNegocio.setHorizontalAlignment(javax.swing.SwingConstants.CENTER);
        lblTituloNombreNegocio.setText("Nombre Negocio");
        lblTituloNombreNegocio.setMaximumSize(new java.awt.Dimension(0, 0));
        lblTituloNombreNegocio.setMinimumSize(new java.awt.Dimension(0, 0));
        lblTituloNombreNegocio.setPreferredSize(new java.awt.Dimension(0, 0));
        gridBagConstraints = new java.awt.GridBagConstraints();
        gridBagConstraints.fill = java.awt.GridBagConstraints.BOTH;
        gridBagConstraints.weightx = 3.0;
        gridBagConstraints.weighty = 1.0;
        contenedorTitulosTabla.add(lblTituloNombreNegocio, gridBagConstraints);

        lblTituloNombreContacto.setFont(new java.awt.Font("Arial", 1, 16)); // NOI18N
        lblTituloNombreContacto.setHorizontalAlignment(javax.swing.SwingConstants.CENTER);
        lblTituloNombreContacto.setText("Nombre contacto");
        lblTituloNombreContacto.setMaximumSize(new java.awt.Dimension(0, 0));
        lblTituloNombreContacto.setMinimumSize(new java.awt.Dimension(0, 0));
        lblTituloNombreContacto.setPreferredSize(new java.awt.Dimension(0, 0));
        gridBagConstraints = new java.awt.GridBagConstraints();
        gridBagConstraints.fill = java.awt.GridBagConstraints.BOTH;
        gridBagConstraints.weightx = 3.0;
        gridBagConstraints.weighty = 1.0;
        contenedorTitulosTabla.add(lblTituloNombreContacto, gridBagConstraints);

        lblTituloDireccion.setFont(new java.awt.Font("Arial", 1, 16)); // NOI18N
        lblTituloDireccion.setHorizontalAlignment(javax.swing.SwingConstants.CENTER);
        lblTituloDireccion.setText("Direccion");
        lblTituloDireccion.setMaximumSize(new java.awt.Dimension(0, 0));
        lblTituloDireccion.setMinimumSize(new java.awt.Dimension(0, 0));
        lblTituloDireccion.setPreferredSize(new java.awt.Dimension(0, 0));
        gridBagConstraints = new java.awt.GridBagConstraints();
        gridBagConstraints.fill = java.awt.GridBagConstraints.BOTH;
        gridBagConstraints.weightx = 3.0;
        gridBagConstraints.weighty = 1.0;
        contenedorTitulosTabla.add(lblTituloDireccion, gridBagConstraints);
        ...
        tituloSinDatos.setText("Aún no tienes clientes registrados");
        ...
        labelDescripcionSinDatos.setText("Comienza a organizar tu inventario agregando tu primer cliente ahora mismo.");
    ...
    */
    ...
    /*
    Metodo para poder agregar toda la lista de clientes recibida, por medio de
    LinkedHashMap mantenemos el orden en el cual ha sido enviada.
    */
    public void inyectarFilas( LinkedHashMap<Integer, FilaTablaClientes> filasTablaClientes ){
        removerContenido();
        
        filasTablaClientes.values().forEach(fila -> {
    ...
    un nuevo cliente
    */
    public void inyectarNuevaFila( FilaTablaClientes fila ){
        contenedorContenidoTabla.add(fila);
        redubijarPanel();
    }
    
    public void eliminarFila ( FilaTablaClientes fila ){
    ...
    */
    ...
    // Metodo para optener cual es el frame padre de la vista JPanel modulo de clientes
    ...
    private javax.swing.JLabel lblTituloNombreContacto;
    private javax.swing.JLabel lblTituloNombreNegocio;
