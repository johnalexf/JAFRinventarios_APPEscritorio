 ...
 * @author JOHN FORERO
 */
public class DialogoFormularioCliente extends DialogoBaseConSombra{
    ...
    */
    ...
    private GestorFormulario formularioDatosCliente;
    ...
    */
    public DialogoFormularioCliente(   Window parent, 
                                        TipoDialogo tipoDialogo) {
        
        super(parent);
        initComponents();
        
        formularioDatosCliente = new GestorFormulario();
        this.tipoDialogo = tipoDialogo;
        
        if (this.tipoDialogo == TipoDialogo.CREAR_NUEVO_CLIENTE) {
            contenedorIdRegistro.setVisible(false);
            tituloFormulario.setText("Crear Nuevo Cliente");
            btnEnviarFormulario.setText("Crear Cliente");
            /*
    ...
    private void agregarCamposAGestorFormulario(){
        ...
        formularioDatosCliente.agregarCampoTexto(inputNombreNegocio, 
                                            lblErrorInputNombreNegocio, 
                                            TipoDatoFormulario.NOMBRE_EMPRESA, 
                                            true);
        
        formularioDatosCliente.agregarCampoTexto( inputCorreo, 
                                            lblErrorInputCorreo, 
                                            TipoDatoFormulario.CORREO, 
                                            true);
        
        formularioDatosCliente.agregarCampoTexto( inputDireccion, 
                                            lblErrorInputDireccion, 
                                            TipoDatoFormulario.REQUERIDO, 
                                            true);
        
        formularioDatosCliente.agregarCampoTexto( inputPrimerNombre, 
                                            lblErrorInputPrimerNombre, 
                                            TipoDatoFormulario.NOMBRE_PERSONA, 
                                            true);

        formularioDatosCliente.agregarCampoTexto( inputSegundoNombre, 
                                            lblErrorInputSegundoNombre, 
                                            TipoDatoFormulario.NOMBRE_PERSONA, 
                                            false);

        formularioDatosCliente.agregarCampoTexto( inputPrimerApellido, 
                                            lblErrorInputPrimerApellido, 
                                            TipoDatoFormulario.NOMBRE_PERSONA, 
                                            true);

        formularioDatosCliente.agregarCampoTexto( inputSegundoApellido, 
                                            lblErrorInputSegundoApellido, 
                                            TipoDatoFormulario.NOMBRE_PERSONA, 
                                            false);

        formularioDatosCliente.agregarCampoTexto( inputTelefono, 
    ...
    private void initComponents() {
        ...
        contenedorInputYErrorNombreNegocio = new javax.swing.JPanel();
        inputNombreNegocio = new javax.swing.JTextField();
        lblErrorInputNombreNegocio = new javax.swing.JLabel();
        ...
        labelNombreNegocio.setFont(new java.awt.Font("Arial", 0, 16)); // NOI18N
        labelNombreNegocio.setHorizontalAlignment(javax.swing.SwingConstants.RIGHT);
        labelNombreNegocio.setText("Nombre del Negocio :");
        labelNombreNegocio.setVerticalAlignment(javax.swing.SwingConstants.TOP);
        labelNombreNegocio.setBorder(javax.swing.BorderFactory.createEmptyBorder(8, 0, 0, 0));
        labelNombreNegocio.setHorizontalTextPosition(javax.swing.SwingConstants.RIGHT);
        labelNombreNegocio.setMaximumSize(new java.awt.Dimension(0, 0));
        labelNombreNegocio.setMinimumSize(new java.awt.Dimension(0, 0));
        labelNombreNegocio.setPreferredSize(new java.awt.Dimension(0, 0));
        gridBagConstraints = new java.awt.GridBagConstraints();
        gridBagConstraints.gridx = 0;
        ...
        contenedorEntradasDatosGenerales.add(labelNombreNegocio, gridBagConstraints);

        contenedorInputYErrorNombreNegocio.setOpaque(false);
        contenedorInputYErrorNombreNegocio.setPreferredSize(new java.awt.Dimension(0, 52));
        contenedorInputYErrorNombreNegocio.setLayout(new java.awt.BorderLayout());

        inputNombreNegocio.setFont(new java.awt.Font("Arial", 0, 16)); // NOI18N
        inputNombreNegocio.setMargin(new java.awt.Insets(4, 10, 4, 10));
        inputNombreNegocio.setName("nombreNegocio"); // NOI18N
        inputNombreNegocio.setPreferredSize(new java.awt.Dimension(0, 34));
        contenedorInputYErrorNombreNegocio.add(inputNombreNegocio, java.awt.BorderLayout.NORTH);

        lblErrorInputNombreNegocio.setFont(new java.awt.Font("Arial", 1, 13)); // NOI18N
        lblErrorInputNombreNegocio.setForeground(new java.awt.Color(179, 38, 30));
        lblErrorInputNombreNegocio.setBorder(javax.swing.BorderFactory.createEmptyBorder(2, 8, 0, 0));
        lblErrorInputNombreNegocio.setHorizontalTextPosition(javax.swing.SwingConstants.CENTER);
        lblErrorInputNombreNegocio.setPreferredSize(new java.awt.Dimension(0, 17));
        contenedorInputYErrorNombreNegocio.add(lblErrorInputNombreNegocio, java.awt.BorderLayout.SOUTH);
        ...
        contenedorEntradasDatosGenerales.add(contenedorInputYErrorNombreNegocio, gridBagConstraints);
        ...
        inputCorreo.setName("correoCliente"); // NOI18N
        ...
        inputDireccion.setName("direccionCliente"); // NOI18N
    ...
    */
    ...
    public void mostrarBtnLinkEliminarCliente(){
        btnLinkEliminarRegistro.setVisible(true);
        DinamismoLink.aplicarEfecto(btnLinkEliminarRegistro);
    }
    
    public void mostrarBtnEditarEstadoCliente(){
        btnLinkEditarEstadoRegistro.setVisible(true);
        DinamismoLink.aplicarEfecto(btnLinkEditarEstadoRegistro);
    }
    
    public void asignarIntencionBtnEditarEstadoCliente(boolean habilitado){
        
        if(habilitado){
            //Si esta habilitado el cliente, se muestra el boton para demostrar
            //la intencion de poder deshabilitarlo
            btnLinkEditarEstadoRegistro.setForeground(new java.awt.Color(200, 0, 0));
            btnLinkEditarEstadoRegistro.setText("Deshabilitar Cliente");
        }else{
            btnLinkEditarEstadoRegistro.setForeground(new java.awt.Color(17, 35, 85));
            btnLinkEditarEstadoRegistro.setText("Habilitar Cliente");
        }
    ...
    public JButton getBtnLinkEditarEstadoCliente(){
        return btnLinkEditarEstadoRegistro;
    }
    
    public JButton getBtnLinkEliminarCliente(){
    ...
    */
    ...
    private javax.swing.JPanel contenedorInputYErrorNombreNegocio;
    ...
    private javax.swing.JTextField inputNombreNegocio;
    ...
    private javax.swing.JLabel lblErrorInputNombreNegocio;
