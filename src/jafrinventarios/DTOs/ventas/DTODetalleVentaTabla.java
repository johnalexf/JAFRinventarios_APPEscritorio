 ...
 * @author JOHN FORERO
 */
public class DTODetalleVentaTabla {
    ...
    */
    ...
    public DTODetalleVentaTabla(String nombreProducto, int cantidadProducto, double precioUnitarioProducto, double precioTotalProducto) {
    ...
    */
    ...
    ver el usuario, para editar un detalle se usara como tal ModeloDetallleVenta
    */     
